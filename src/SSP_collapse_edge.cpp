...
"\n"
"File naming:  collapse_<N>_sid_<SID>_vi_<VI>_vj_<VJ>_case_<C>.ply\n"
"\n"
"  N    --  Timeline marker: the most recent SUCCESSFUL collapse at the moment\n"
"           this failure occurred. It does NOT identify which collapse failed.\n"
"           The failed attempt has no number of its own because it never succeeded.\n"
"\n"
"           Example: collapse_1_sid_0_vi_1381_vj_1470_case_0.ply\n"
"             - Collapse #1 had just succeeded (ImGui counter shows 1).\n"
"             - The edge (vi=1381, vj=1470) on sheet 0 was then tried and\n"
"               rejected by joint_lscm. That failing edge's one-ring is what\n"
"               this PLY holds.\n"
"             - The PLY has nothing to do with collapse #1 geometrically.\n"
"\n"
"           N = -1 means the failure happened before ANY successful collapse\n"
"           (counter not yet set; these are very early-run failures).\n"
"\n"
"  SID  --  Local BFS sheet id of the failing edge's patch.\n"
"  VI   --  Global index of the surviving vertex (vi) of the failing edge.\n"
"  VJ   --  Global index of the absorbed vertex (vj) of the failing edge.\n"
"\n"
"  Cross-referencing with the rejection log:\n"
"    Each PLY maps exactly to one [LSCM-FAIL] line in the log:\n"
"      collapse_1_sid_0_vi_1381_vj_1470_case_0.ply\n"
"        <-->  [LSCM-FAIL] collapse=#1  sid=0  e=(1470,1381)  vi=1381  vj=1470  case=0\n"
"    The [LSCM-DIAG] line immediately after gives the failure reason.\n"
"\n"
"  IMPORTANT: the PLY content is the pre-collapse one-ring patch of the FAILING\n"
"  edge (vi, vj), not of collapse N. Open it in MeshLab to see the exact 3D\n"
"  geometry that joint_lscm could not handle.\n"
"\n"
