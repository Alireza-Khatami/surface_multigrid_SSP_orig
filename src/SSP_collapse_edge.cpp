...
"\n"
"         Example: collapse_1_case_0.ply\n"
"           - Collapse #1 had just succeeded (ImGui counter shows 1).\n"
"           - The very next edge popped from the queue was tried and rejected\n"
"             by joint_lscm. That failing edge's one-ring is what this PLY holds.\n"
...
"  edge, not of collapse N. Open it in MeshLab to see the exact 3D geometry\n"
"  that joint_lscm could not handle.\n"
"\n"
