...
def load_vertex_tracker(bundle_path: str):
    ...
    """
    global _tracker_vtx_fine_pts, _tracker_vtx_coarse_pts, _tracker_vtx_coarse_fids
    ...
    # coarse_face_id (column 1) is the global gF face index used for face filtering
    _tracker_vtx_coarse_fids = data[:, 1].astype(np.int32)
